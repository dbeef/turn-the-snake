...
public class GameScreenTriangle implements Screen {
...
public GameScreenTriangle(final Starter myGdxGame) {
...
public void goOut(){
	...
	if(tryAgainBoolean == true && timerOut == 0.9f){	game.setScreen(new GameScreenTriangle(game));
	}
