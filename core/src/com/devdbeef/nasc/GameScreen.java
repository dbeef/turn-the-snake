...
public GameScreen(final Starter myGdxGame) {
...
spawnApple();
	...
	public void render(float delta) {
		...
		//game.efektPentagon.draw(game.batch, delta);
...
//Score!
//	spawnApple();
	//game.efektPentagon.setPosition(apple.x, apple.y);
	//game.efektPentagon.start();
...
public void goOut(){
	...
	if(tryAgainBoolean == true && timerOut == 0.9f){	game.setScreen(new GameScreen(game));
	}
